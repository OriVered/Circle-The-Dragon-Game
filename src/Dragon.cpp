...
Dragon::Dragon(const LocIndx& loc)
	:m_loc(loc), m_animation(Type_t::dragons, DragonImageCount, DragonSwitchTime), m_speed(MoveSpeed), m_isMoving(false), m_faceRight(true)
{
	m_dragonBody.setSize(DragonSize);
